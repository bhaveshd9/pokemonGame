...
int main(int argc, char *argv[])
{
    ...
    if(argc == 2) { 
        if (strcmp(argv[1], "pokemon") == 0) { 
            ...
            if (!got_data) {
                std::cerr << "No pokemon data found." << std::endl;
            } else {
            ...
            if (!got_data) {
                std::cerr << "No pokemon types data found." << std::endl;
            }else {
            ...
            if (!got_data) {
                std::cerr << "No type names data found." << std::endl;
            } else {
            ...
            if (!got_data) {
                std::cerr << "No pokemon species data found." << std::endl;
            } else {
            ...
            if (!got_data) {
                std::cerr << "No pokemon stats data found." << std::endl;
            } else {
            ...
            if (!got_data) {
                std::cerr << "No stats data found." << std::endl;
            } else {
            ...
            if (!got_data) {
                std::cerr << "No pokemon moves data found." << std::endl;
            } else {
            ...
            if (!got_data) {
                std::cerr << "No moves data found." << std::endl;
            } else {
            ...
            if (!got_data) {
                std::cerr << "No experience data found." << std::endl;
            } else {
